...
- **Routing is deterministic.** *(Specifics TBD — the bindings model is being
  re-thought; see `invariants.md` invariant #3.)* What's settled: routing is
  deterministic and user-intent beats heuristic fallback.
