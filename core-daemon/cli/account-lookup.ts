...
export async function accountLookup(options: AccountLookupOptions): Promise<AccountLookupResult> {
...
export function formatAccountLookup(result: AccountLookupResult): string {
  const lines = [
