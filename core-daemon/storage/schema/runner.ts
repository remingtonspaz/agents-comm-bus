...
export const sessionLabelScopeMigration: Migration = {
  version: 12,
...
export const curlInboundIdempotencyMigration: Migration = {
  version: 13,
...
export const registrationActivationMigration: Migration = {
  version: 14,
...
export const sessionOwnerProcessStartTimeMigration: Migration = {
  version: 15,
