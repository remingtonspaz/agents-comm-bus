...
export function curlReceiptTtlMs(env = process.env) {
...
export function validateCurlIdempotencyKey(raw) {
...
const METADATA_UNSUPPORTED = "body.metadata must contain only JSON values (null, boolean, number, string, object, array)";
export function validateCurlMetadata(raw) {
    if (raw == null)
        return { metadata: {} };
...
export function curlIdempotencyScopeKey(scope) {
...
export function curlRequestHash(input) {
