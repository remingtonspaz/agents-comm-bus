 ...
 */
export async function entryEnsures(_options) {
    throw new Error("agents-comm-bus/host-entry: entryEnsures is an AGE-60 scaffold stub. " +
...
export const HOST_ENTRY_SCAFFOLD = true;
